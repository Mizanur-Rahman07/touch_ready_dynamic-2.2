...
<main class="mainBody">
    ...
    <section id="All_product" class="background-res background-ats py-3 justify-content-center align-items-center"
        style="background-image: url('{{asset('frontEndAsset')}}/assets/images/background_img/Background-Image-1.png');">
        <div class="mb-5 mt-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col_5_change mb-2">
                        <div class="product_col f_border text-center">
                            <div class="product_img">
                                <img src="{{asset($book->product_image)}}" alt="" srcset="" />
                            </div>
                            <div class="product_content">
                                ...
                                <small><s
                                        class="text-secondary">${{substr($book->product_discount_price,0,20)}}</s></small>
